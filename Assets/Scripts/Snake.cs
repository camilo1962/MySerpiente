...
public class Snake : MonoBehaviour
{
        ...
        if (gridMoveTimer >= gridMoveTimerMax) {
            ...
            foreach (SnakeBodyPart snakeBodyPart in snakeBodyPartList) {
                ...
                if (gridPosition == snakeBodyPartGridPosition) {
                    // Game Over!
                    //CMDebug.TextPopup("¡MUERTO!", transform.position);
                    state = State.Dead;
    ...
    // Return the full list of position ocupied by the snake: Head and body
            ...
            case Direction.Up: // Currently going Up
                 ...
                 default:
                  ...
                  case Direction.Right: // Previously was going Right
                    ...
                    break;
                  case Direction.Down: // Current going Down
                    switch (snakeMovePosition.GetPreviousDirection()) {
                        default:
                            angle = 180; break;
                        case Direction.Left: // Previously was going Left
                    ...
                    break;
                case Direction.Left: // Current going the Left
                    switch (snakeMovePosition.GetPreviousDirection()) {
                        default:
                            angle = -90; break;
                ...
                case Direction.Right: // Currently going to the Right
                 switch (snakeMovePosition.GetPreviousDirection()) {
                    default:
                        angle = 90; break;
                    case Direction.Down: // Previoulsly was going down
                        angle = 45; break;
                 }
                break;
            }
    ...
    /*
    * Handles one Move Position fron the snake
    * */
